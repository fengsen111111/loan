...
@dark-color-border-table: #484849;
...
@link-color-text_hover: rgb(var(--primary-5));
@link-color-text_active: rgb(var(--link-7));
@link-color-text_disabled: rgb(var(--link-3));
@link-color-text_loading: var(--color-link-light-3);
...
@link-color-text_success_loading: var(--color-success-light-3);
...
@link-color-text_error_loading: var(--color-danger-light-3);
...
@link-color-text_warning_loading: var(--color-warning-light-2);
...
@size-medium: 32px;
@icon-hover-size-medium-height: 20px;
@icon-hover-size-medium-icon: 12px;
...
@popup-shadow: 0 2px 5px rgba(0, 0, 0, 0.1);
@popup-padding-content-top: 4px;
...
@popup-color-border: var(--color-border-2);
...
@trigger-border-arrow-radius: var(--border-radius-small);
...
@input-color-bg_hover: transparent;
@input-color-bg_focus: var(--color-bg-2);
@input-color-bg_disabled: var(--color-fill-1);
@input-color-addon-bg: transparent;
...
@input-color-addon-border_default: var(--color-border-3);
@input-color-text: var(--color-text-1);
@input-color-placeholder-text: var(--color-text-4);
@input-color-text_disabled: var(--color-text-4);
@input-color-bg_error: var(--color-bg-2);
@input-color-bg_error_hover: var(--color-bg-2);
...
@input-color-border_disabled: var(--color-border-2);
@input-color-border_hover: var(--color-border-4);
@input-color-border_error: rgb(var(--danger-6));
@input-color-border_error_hover: rgb(var(--danger-5));
...
@input-size-medium-height: 32px;
@input-size-medium-font-size: 14px;
@input-size-mini-line-height: 1.667;
@input-size-small-line-height: 1.5715;
@input-size-medium-line-height: 1.5715;
@input-size-large-line-height: 1.5715;
@input-feedback-icon-color_success: rgb(var(--success-6));
@input-feedback-icon-color_error: rgb(var(--danger-6));
@input-feedback-icon-color_warning: rgb(var(--warning-6));
@input-feedback-icon-color_validating: rgb(var(--primary-6));
...
@input-tag-size-large-font-size: 14px;
...
@input-tag-tag-color-bg_focus: transparent;
...
@input-tag-tag-color-border_focus: var(--color-fill-3);
@input-tag-tag-remove-icon-color-bg: var(--color-fill-2);
@input-tag-tag-remove-icon-color-bg_focus: var(--color-fill-3);
@input-tag-size-medium-height: 32px;
@input-tag-size-medium-tag-height: 24px;
@input-tag-size-medium-font-size: 14px;
...
@input-tag-color-addon-text: var(--color-text-2);
...
@picker-input-border-radius: 4px;
...
@picker-color-bg_disabled: var(--color-fill-1);
...
@picker-color-border_hover: var(--color-border-4);
@picker-color-border_focus: rgb(var(--primary-6));
@picker-color-border_disabled: var(--color-border-2);
...
@picker-color-placeholder: var(--color-text-4);
...
@picker-range-color-bg-input_focus: var(--color-fill-2);
...
@picker-color-bg-cell-hover-in-range: var(--color-primary-light-1);
...
@picker-panel-border-radius-cell_selected: var(--border-radius-circle);
@picker-panel-cell-boundary-border-radius: 24px;
@picker-panel-cell-border-radius: 24px;
...
@tag-size-medium-font-size: 12px;
...
@select-popup-option-font-highlight-weight: 500;
...
@select-size-large-font-size: @font-size-title-1;
...
@select-color-addon-text: var(--color-text-2);
...
@alert-padding-horizontal_with_title: 15px;
@alert-padding-vertical_with_title: 15px;
...
@alert-normal-color-bg: var(--color-neutral-2);
@alert-normal-color-border: transparent;
@alert-normal-color-icon: var(--color-neutral-4);
@alert-normal-color-text-title: var(--color-text-1);
@alert-normal-color-text-content: var(--color-text-1);
@alert-normal-color-text-content_title: var(--color-text-2);
...
@avatar-color-bg: var(--color-neutral-3);
...
@breadcrumb-size-separator-height: 12px;
...
@btn-size-default-radius: 4px;
@btn-size-large-radius: 4px;
...
@btn-size-mini-icon-spacing: 6px;
@btn-size-small-icon-spacing: 4px;
...
@btn-secondary-color-text_active: var(--color-text-1);
@btn-secondary-color-bg: transparent;
@btn-secondary-color-bg_disabled: var(--color-fill-1);
@btn-secondary-color-bg_hover: transparent;
@btn-secondary-color-bg_active: var(--color-fill-2);
@btn-secondary-color-border: var(--color-border-3);
@btn-secondary-color-border_disabled: var(--color-border-2);
@btn-secondary-color-border_hover: var(--color-border-3);
@btn-secondary-color-border_active: var(--color-border-4);
...
@btn-dashed-color-text: rgb(var(--primary-6));
@btn-dashed-color-text_disabled: var(--color-primary-light-3);
@btn-dashed-color-text_hover: rgb(var(--primary-5));
@btn-dashed-color-text_active: rgb(var(--primary-7));
@btn-dashed-color-bg: transparent;
@btn-dashed-color-bg_disabled: transparent;
@btn-dashed-color-bg_hover: transparent;
@btn-dashed-color-bg_active: rgb(var(--primary-1));
@btn-dashed-color-border: rgb(var(--primary-6));
@btn-dashed-color-border_disabled: var(--color-primary-light-4);
@btn-dashed-color-border_hover: rgb(var(--primary-5));
@btn-dashed-color-border_active: rgb(var(--primary-7));
@btn-dashed-color-text_warning: rgb(var(--warning-6));
@btn-dashed-color-text_warning_disabled: var(--color-warning-light-3);
@btn-dashed-color-text_warning_hover: rgb(var(--warning-5));
@btn-dashed-color-text_warning_active: rgb(var(--warning-7));
@btn-dashed-color-bg_warning: transparent;
@btn-dashed-color-bg_warning_disabled: transparent;
@btn-dashed-color-bg_warning_hover: transparent;
@btn-dashed-color-bg_warning_active: rgb(var(--warning-1));
@btn-dashed-color-border_warning: rgb(var(--warning-6));
@btn-dashed-color-border_warning_disabled: var(--color-warning-light-3);
@btn-dashed-color-border_warning_hover: rgb(var(--warning-5));
@btn-dashed-color-border_warning_active: rgb(var(--warning-7));
@btn-dashed-color-text_danger: rgb(var(--danger-6));
@btn-dashed-color-text_danger_disabled: var(--color-danger-light-3);
@btn-dashed-color-text_danger_hover: rgb(var(--danger-5));
@btn-dashed-color-text_danger_active: rgb(var(--danger-7));
@btn-dashed-color-bg_danger: transparent;
@btn-dashed-color-bg_danger_disabled: transparent;
@btn-dashed-color-bg_danger_hover: transparent;
@btn-dashed-color-bg_danger_active: var(--color-danger-light-1);
@btn-dashed-color-border_danger: rgb(var(--danger-6));
@btn-dashed-color-border_danger_disabled: var(--color-danger-light-2);
@btn-dashed-color-border_danger_hover: rgb(var(--danger-5));
@btn-dashed-color-border_danger_active: rgb(var(--danger-7));
@btn-dashed-color-text_success: rgb(var(--success-6));
@btn-dashed-color-text_success_disabled: var(--color-success-light-3);
@btn-dashed-color-text_success_hover: rgb(var(--success-5));
@btn-dashed-color-text_success_active: rgb(var(--success-7));
@btn-dashed-color-bg_success: transparent;
@btn-dashed-color-bg_success_disabled: transparent;
@btn-dashed-color-bg_success_hover: transparent;
@btn-dashed-color-bg_success_active: var(--color-success-light-1);
@btn-dashed-color-border_success: rgb(var(--success-6));
@btn-dashed-color-border_success_disabled: var(--color-success-light-2);
@btn-dashed-color-border_success_hover: rgb(var(--success-5));
@btn-dashed-color-border_success_active: rgb(var(--success-7));
...
@btn-size-medium-radius: 4px;
@btn-size-medium-border-width: 1px;
@btn-size-medium-icon-spacing: 8px;
@btn-size-medium-icon-vertical-align: -2px;
@btn-size-medium-padding-horizontal: 15px;
@btn-size-medium-font-size: 14px;
@btn-size-medium-height: 32px;
...
@card-size-default-padding-vertical-title: 10px;
...
@dropdown-group-title-padding-top: 8px;
...
@checkbox-mask-color-border_hover: var(--color-fill-3);
@checkbox-mask-color-border_checked: transparent;
@checkbox-mask-color-border_checked_disabled: transparent;
@checkbox-mask-color-border_disabled: var(--color-border-2);
...
@collapse-color-border: var(--color-border-2);
@collapse-line-height: 1.5715;
@collapse-title-line-height: 24px;
@collapse-title-border-width: 1px;
@collapse-title-color-border: var(--color-border-2);
@collapse-title-font-size: 14px;
@collapse-title-padding-horizontal: 12px;
...
@collapse-content-color-text_disabled: var(--color-text-4);
@collapse-content-font-size: 14px;
@collapse-content-padding-vertical: 8px;
@collapse-content-color-bg: var(--color-bg-5);
...
@collapse-item-color-border: var(--color-border-2);
...
@datepicker-view-tab-pane-color-text_unactive: var(--color-text-4);
@datepicker-view-tab-pane-color-text_active: var(--color-text-1);
...
@descriptions-color-border: var(--color-border-2);
...
@divider-color-bg: var(--color-border-2);
...
@drawer-padding-footer-vertical: 10px;
@drawer-padding-content-vertical: 12px;
@drawer-font-header-weight: 500;
@drawer-color-border: var(--color-border-2);
...
@form-color-bg_warning: var(--color-bg-2);
@form-color-bg_warning_hover: var(--color-bg-2);
...
@form-color-bg_error: var(--color-bg-2);
@form-color-bg_error_hover: var(--color-bg-2);
...
@list-border-color: var(--color-border-2);
...
@list-size-medium-padding-vertical-header: 12px;
@list-size-medium-padding-horizontal-header: 20px;
@list-size-medium-padding-vertical-item: 13px;
@list-size-medium-padding-horizontal-item: 20px;
...
@modal-margin-footer-button-left: 10px;
@modal-color-border: var(--color-border-3);
...
@modal-default-padding-content-vertical: 18px;
@modal-default-padding-footer-vertical: 12px;
...
@modal-simple-margin-footer-top: 20px;
...
@page-header-size-title-text: 16px;
...
@popconfirm-padding-vertical: 14px;
...
@popconfirm-color-content-bg: var(--color-bg-popup);
@popconfirm-color-border: var(--color-neutral-3);
@popconfirm-border-radius: var(--border-radius-medium);
@popconfirm-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);
@popconfirm-color-title-icon: rgb(var(--warning-6));
@popconfirm-color-title-icon_danger: rgb(var(--danger-6));
@popconfirm-color-title-icon_success: rgb(var(--success-6));
@popconfirm-color-title-icon_info: rgb(var(--primary-6));
...
@progress-line-size-text-width: 32px;
...
@radio-color-border: var(--color-fill-3);
@radio-border-width: 1px;
@radio-layout-height: 16px;
@radio-color-border_hover: var(--color-fill-3);
...
@scrollbar-track-border_size: 1px;
@scrollbar-track-border_color: var(--color-neutral-3);
@scrollbar-track-bg_color: var(--color-neutral-1);
@scrollbar-thumb-bar-size: 9px;
@scrollbar-thumb-bar-border_radius: 6px;
@scrollbar-thumb-bar-bg_color: var(--color-neutral-4);
@scrollbar-thumb-bar-bg_color_hover: var(--color-neutral-6);
...
@split-trigger-color-background: var(--color-neutral-3);
@split-trigger-size-icon-wrapper: 6px;
@split-trigger-font-size-icon: 12px;
@split-trigger-color-icon: var(--color-text-1);
@split-prefix-cls: ~'@{prefix}-split';
@split-trigger-prefix-cls: ~'@{prefix}-split-trigger';
...
@statistic-font-value-size: 14px;
...
@switch-circle-default-width: 44px;
@switch-circle-small-width: 28px;
@switch-round-default-width: 44px;
...
@table-color-border: var(--color-border-table);
@table-border-radius: 0;
@table-color-text-header-cell: var(--color-text-2);
@table-color-bg-header-cell: var(--color-fill-1);
...
@table-color-text-body-cell: var(--color-text-1);
...
@table-size-large-padding-horizontal: 16px;
@table-size-large-padding-vertical: 9px;
@table-size-large-font-size: 14px;
@table-size-large-font-header-size: 14px;
@table-size-medium-padding-horizontal: 16px;
@table-size-medium-padding-vertical: 7px;
@table-size-medium-font-size: 14px;
@table-size-medium-font-header-size: 14px;
@table-color-bg-tfoot: var(--color-neutral-2);
@table-filters-icon-bg_hover: var(--color-fill-4);
@table-color-border_resizing: rgb(var(--primary-6));
@table-prefix-cls: ~'@{prefix}-table';
@table-cls-table: arco-table-element;
...
@tabs-color-title-text_hover: var(--color-text-1);
...
@tabs-line-color-header-border: var(--color-border-2);
@tabs-line-size-ink-stroke: 1.6px;
...
@tabs-line-color-title-bg_hover: var(--color-neutral-2);
...
@tabs-text-size-separator-width: 1.5px;
...
@tabs-capsule-padding-header-vertical: 2px;
@tabs-capsule-padding-header-horizontal: 2px;
...
@tooltip-padding-vertical: 4px;
@tooltip-mini-padding-horizontal: 10px;
@tooltip-mini-padding-vertical: 4px;
@tooltip-mini-font-size: 12px;
...
@tree-showline-color-line-bg: var(--color-border-2);
