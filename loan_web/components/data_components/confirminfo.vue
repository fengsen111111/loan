<template>
	<view class="confirminfo">
		...
		<optionBt showCancel cancelText="信息编辑" cancelColor="#999999" cancelBgColor="#F6F7FB" @cancel="skipStep()" @confirm="nextStep()" confirmBgColor="#109181" confirmText="提交"></optionBt>
...
<script setup lang="ts">
	...
	import { reactive, defineEmits, defineProps,getCurrentInstance } from "vue"
