...
export const zqzrxy = (data) => {  
  return new Promise((resolve, reject) => {
    ...
    let info = ``
      info += `<div style="text-indent: 2em;">
      <p>J0707-4</p>
      ...
      `
    let seal = `<img style="width: 160px;height: 160px;position: absolute;bottom: -1970px;left: 200px;" src="${sealImg}"/>
       <img style="width: 160px;height: 160px;position: absolute;bottom: -2100px;left: 200px;" src="${sealImg}"/> `
    // let seal = `<img style="width: 200px;height: 200px;position: absolute;bottom: -20px;right: 20px;" src="${sealImg}"/>`
    let html = `${title}${info}${seal}`
    let body = document.createElement('div')
    body.style.width = '380px'
    body.style.margin = '0 auto'
    body.style.padding = '50px'
