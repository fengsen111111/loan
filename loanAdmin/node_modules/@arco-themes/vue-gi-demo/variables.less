...
@color-text-1: rgb(18, 19, 20);
@color-bg-white: #ffffff;
@color-white: #ffffff;
@dark-color-text-2: rgba(255, 255, 255, 0.7);
@dark-color-white: rgba(255, 255, 255, 0.9);
@color-text-3: rgb(144, 147, 153);
@color-text-2: rgb(92, 92, 92);
@color-text-4: rgb(194, 194, 194);
...
@color-bg-2: #ffffff;
@color-border-3: rgb(220, 223, 230);
...
@btn-secondary-color-bg: @color-transparent;
@btn-secondary-color-border: var(~'@{arco-cssvars-prefix}-color-border-3');
@btn-secondary-color-bg_hover: @color-transparent;
@btn-secondary-color-border_hover: var(~'@{arco-cssvars-prefix}-color-border-3');
@btn-secondary-color-bg_active: var(~'@{arco-cssvars-prefix}-color-fill-2');
@btn-secondary-color-border_active: var(~'@{arco-cssvars-prefix}-color-border-4');
@tooltip-padding-vertical: @spacing-2;
@checkbox-mask-border-width: @border-1;
@checkbox-mask-height: @size-4;
@input-color-border: var(~'@{arco-cssvars-prefix}-color-border-3');
@input-color-bg: @color-transparent;
@input-color-bg_hover: @color-transparent;
@input-color-border_hover: var(~'@{arco-cssvars-prefix}-color-border-4');
@radio-border-width: @border-1;
@radio-layout-height: @size-4;
@radio-margin-text-left: @spacing-3;
@switch-circle-default-width: @size-11;
@switch-round-default-width: @size-11;
@drawer-padding-content-vertical: @spacing-6;
@drawer-padding-footer-vertical: @spacing-5;
@modal-default-padding-footer-vertical: @spacing-6;
@popconfirm-padding-vertical: 14px;
@page-header-size-title-text: @font-size-title-1;
@input-color-placeholder-text: var(~'@{arco-cssvars-prefix}-color-text-4');
@collapse-content-color-bg: var(~'@{arco-cssvars-prefix}-color-bg-5');
@card-size-default-height-title: @size-11;
@tabs-capsule-padding-header-vertical: @spacing-1;
@tabs-capsule-padding-header-horizontal: @spacing-1;
@tooltip-mini-font-size: @font-size-body-1;
@tooltip-mini-padding-horizontal: @spacing-5;
...
@picker-color-bg: @color-transparent;
@picker-color-border: var(~'@{arco-cssvars-prefix}-color-border-3');
@picker-color-border_hover: var(~'@{arco-cssvars-prefix}-color-border-4');
@picker-color-bg_focus: @color-transparent;
@picker-color-bg_hover: @color-transparent;
@avatar-color-bg: @color-fill-3;
@empty-color-text: var(~'@{arco-cssvars-prefix}-color-text-4');
@empty-color-icon: var(~'@{arco-cssvars-prefix}-color-text-4');
@table-font-weight-header-text: @font-weight-500;
@table-color-text-header-cell: var(~'@{arco-cssvars-prefix}-color-text-2');
@table-color-bg-header-cell: var(~'@{arco-cssvars-prefix}-color-fill-1');
@table-color-border: var(~'@{arco-cssvars-prefix}-color-border-table');
@table-color-text-body-cell: var(~'@{arco-cssvars-prefix}-color-text-1');
@table-border-radius: @border-radius-none;
...
@modal-margin-footer-button-left: @spacing-5;
@modal-color-border: var(~'@{arco-cssvars-prefix}-color-border-3');
@modal-simple-margin-footer-top: @spacing-8;
@btn-dashed-color-bg: @color-transparent;
@btn-dashed-color-bg_disabled: @color-transparent;
@btn-dashed-color-bg_hover: @color-transparent;
@btn-dashed-color-bg_active: @color-primary-1;
@btn-dashed-color-bg_warning: @color-transparent;
@btn-dashed-color-bg_warning_disabled: @color-transparent;
@btn-dashed-color-bg_warning_hover: @color-transparent;
@btn-dashed-color-bg_warning_active: @color-warning-1;
@btn-dashed-color-bg_danger: @color-transparent;
@btn-dashed-color-bg_danger_hover: @color-transparent;
@btn-dashed-color-bg_danger_active: var(~'@{arco-cssvars-prefix}-color-danger-light-1');
@btn-dashed-color-bg_success: @color-transparent;
@btn-dashed-color-bg_success_hover: @color-transparent;
@btn-dashed-color-bg_success_active: var(~'@{arco-cssvars-prefix}-color-success-light-1');
@btn-dashed-color-border_warning: @color-warning-6;
@btn-dashed-color-border_warning_active: @color-warning-7;
@btn-dashed-color-border_warning_hover: @color-warning-5;
@btn-dashed-color-border_danger_hover: @color-danger-5;
@btn-dashed-color-border_danger_active: @color-danger-7;
@btn-dashed-color-border_danger: @color-danger-6;
@btn-dashed-color-border_success_hover: @color-success-5;
@btn-dashed-color-border_success_active: @color-success-7;
@btn-dashed-color-border: @color-primary-6;
@btn-dashed-color-border_active: @color-primary-7;
@btn-dashed-color-border_hover: @color-primary-5;
@btn-dashed-color-border_success: @color-success-6;
@btn-dashed-color-border_disabled: var(~'@{arco-cssvars-prefix}-color-primary-light-4');
@btn-dashed-color-text: @color-primary-6;
@btn-dashed-color-text_disabled: var(~'@{arco-cssvars-prefix}-color-primary-light-3');
@btn-dashed-color-text_active: @color-primary-7;
@btn-dashed-color-text_hover: @color-primary-5;
@btn-dashed-color-text_warning_hover: @color-warning-5;
@btn-dashed-color-text_warning_active: @color-warning-7;
...
@btn-dashed-color-border_warning_disabled: var(~'@{arco-cssvars-prefix}-color-warning-light-3');
@btn-dashed-color-bg_danger_disabled: @color-transparent;
@btn-dashed-color-bg_success_disabled: @color-transparent;
@btn-secondary-color-bg_disabled: var(~'@{arco-cssvars-prefix}-color-fill-1');
@btn-secondary-color-border_disabled: var(~'@{arco-cssvars-prefix}-color-border-2');
@input-color-bg_error: var(~'@{arco-cssvars-prefix}-color-bg-2');
@input-color-border_error: @color-danger-6;
@input-color-bg_error_hover: var(~'@{arco-cssvars-prefix}-color-bg-2');
@input-color-border_error_hover: @color-danger-5;
@input-color-bg_disabled: var(~'@{arco-cssvars-prefix}-color-fill-1');
@input-color-border_disabled: var(~'@{arco-cssvars-prefix}-color-border-2');
@form-color-bg_error: var(~'@{arco-cssvars-prefix}-color-bg-2');
@form-color-border_error: @color-danger-6;
@form-color-border_error_hover: @color-danger-5;
@form-color-bg_error_hover: var(~'@{arco-cssvars-prefix}-color-bg-2');
@form-color-bg_warning: var(~'@{arco-cssvars-prefix}-color-bg-2');
@form-color-border_warning: @color-warning-6;
@form-color-bg_warning_hover: var(~'@{arco-cssvars-prefix}-color-bg-2');
@form-color-border_warning_hover: @color-warning-5;
@form-color-bg_validating: var(~'@{arco-cssvars-prefix}-color-bg-2');
@form-color-border_validating: var(~'@{arco-cssvars-prefix}-color-border-3');
@form-color-bg_success: var(~'@{arco-cssvars-prefix}-color-bg-2');
@form-color-border_success: var(~'@{arco-cssvars-prefix}-color-border-3');
@modal-default-padding-content-vertical: 18px;
@tabs-line-color-title-bg_hover: @color-fill-2;
@link-color-text: @color-link-6;
@link-color-text_hover: @color-primary-5;
@link-color-text_active: @color-link-7;
@btn-secondary-color-text: var(~'@{arco-cssvars-prefix}-color-text-1');
@btn-size-mini-icon-spacing: @spacing-3;
@btn-size-small-icon-spacing: @spacing-2;
@popup-shadow: @shadow1-down;
@popup-color-border: var(~'@{arco-cssvars-prefix}-color-border-2');
@modal-border-width: @border-none;
@input-color-addon-border_default: var(~'@{arco-cssvars-prefix}-color-border-3');
@picker-color-border_disabled: var(~'@{arco-cssvars-prefix}-color-border-2');
@select-color-border_default: @color-transparent;
@collapse-color-border: var(~'@{arco-cssvars-prefix}-color-border-2');
@collapse-border-radius: @border-radius-none;
@collapse-title-color-border: var(~'@{arco-cssvars-prefix}-color-border-2');
@collapse-item-color-border: var(~'@{arco-cssvars-prefix}-color-border-2');
@descriptions-border-radius: @border-radius-none;
@descriptions-color-border: var(~'@{arco-cssvars-prefix}-color-border-2');
...
@picker-color-placeholder: var(~'@{arco-cssvars-prefix}-color-text-4');
@picker-color-bg_disabled: var(~'@{arco-cssvars-prefix}-color-fill-1');
@drawer-color-border: var(~'@{arco-cssvars-prefix}-color-border-2');
@pagination-color-text-total: var(~'@{arco-cssvars-prefix}-color-text-1');
@btn-secondary-color-text_active: var(~'@{arco-cssvars-prefix}-color-text-1');
@link-color-text_disabled: @color-link-3;
@divider-color-bg: var(~'@{arco-cssvars-prefix}-color-border-2');
@card-color-border: var(~'@{arco-cssvars-prefix}-color-border-2');
@card-border-radius: @border-radius-none;
@collapse-title-padding-horizontal: @spacing-6;
@empty-spacing-image-margin-bottom: @spacing-2;
@list-border-color: var(~'@{arco-cssvars-prefix}-color-border-2');
@list-border-radius: @border-radius-none;
...
@checkbox-mask-color-border_hover: var(~'@{arco-cssvars-prefix}-color-fill-3');
@checkbox-mask-color-border_disabled: var(~'@{arco-cssvars-prefix}-color-border-2');
@checkbox-mask-color-bg_disabled: var(~'@{arco-cssvars-prefix}-color-fill-2');
@tabs-line-color-header-border: var(~'@{arco-cssvars-prefix}-color-border-2');
@card-color-bg: var(~'@{arco-cssvars-prefix}-color-bg-1');
@tabs-line-color-title-bg: @color-transparent;
@tabs-color-title-text_hover: var(~'@{arco-cssvars-prefix}-color-text-1');
@tree-showline-color-line-bg: var(~'@{arco-cssvars-prefix}-color-border-2');
@input-tag-tag-color-bg_focus: @color-transparent;
@input-tag-tag-color-border_focus: var(~'@{arco-cssvars-prefix}-color-fill-3');
@radio-color-border: var(~'@{arco-cssvars-prefix}-color-fill-3');
@radio-color-border_hover: var(~'@{arco-cssvars-prefix}-color-fill-3');
