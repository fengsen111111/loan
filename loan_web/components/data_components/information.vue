		...
		<view class="content">
			...
			<view class="idcard">
				<view class="item" @click="uploadImg('front')">
					点击上传身份证正面
					<text>（人像）</text>
					<image :src="formData.card_image_front" @click="preImg(formData.card_image_front)" mode="" v-if="formData.card_image_front"></image>
				</view>
				<view class="item" @click="uploadImg('back')">
					点击上传身份证背面
					<text>（国徽）</text>
					<image :src="formData.card_image_back" mode="" @click="preImg(formData.card_image_back)" v-if="formData.card_image_back"></image>
				</view>
			</view>
			<view class="info_item">
				<view class="label">姓名</view>
				<view class="value">
					<input type="text" placeholder="请输入姓名" v-model="formData.name" :disabled="props.showFlag" style="width: 100%;">
				</view>
			</view>
			<view class="info_item">
			...
			<view class="info_item" v-if="!props.showFlag">
				...
				<view class="value">
					<input type="number" placeholder="请输入验证码" v-model="formData.verify_code">
