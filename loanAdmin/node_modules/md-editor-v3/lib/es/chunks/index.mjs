import { inject, onMounted, watch, toRef, nextTick, shallowRef, ref, computed, defineComponent, createVNode, Fragment, reactive, provide, onBeforeUnmount } from "vue";
import { p as prefix, f as configOption, g as codeCss, s as staticTextDefault, b as allToolbar, d as allFooter } from "./config.mjs";
import { b as bus, C as CATALOG_CHANGED, P as PUSH_CATALOG, h as RERENDER, B as BUILD_FINISHED, d as ON_SAVE, E as ERROR_CATCHER, U as UPLOAD_IMAGE, c as CHANGE_CATALOG_VISIBLE, i as PAGE_FULL_SCREEN_CHANGED, F as FULL_SCREEN_CHANGED, j as PREVIEW_CHANGED, k as PREVIEW_ONLY_CHANGED, H as HTML_PREVIEW_CHANGED, l as CATALOG_VISIBLE_CHANGED, R as REPLACE, a as CHANGE_FULL_SCREEN, g as EVENT_LISTENER } from "./event-name.mjs";
...
import { c as generateCodeRowNumber, d as getNextId } from "./index4.mjs";
  ...
  const fenceGroup = (tokens, idx, options, env, slf) => {
    ...
    <${tagHeader2} class="${prefix}-code-head">
      ...
      <div>
        ...
        <span class="${prefix}-copy-button">${(_a = _opts.usedLanguageTextRef.value) == null ? void 0 : _a.copyCode.text}</span>
      </div>
    ...
    <${tagHeader} class="${prefix}-code-head">
      ...
      <div>
        ...
        <span class="${prefix}-copy-button">${(_b = _opts.usedLanguageTextRef.value) == null ? void 0 : _b.copyCode.text}</span>
      </div>
