...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    l: common_vendor.f($data.weekdayArr, (item, index, i0) => {
      return {
        a: index
      };
    }),
    m: common_vendor.f($data.daysArr, (item, index, i0) => {
      return common_vendor.e({
    ...
    n: $data.dateHeight + "px",
    o: common_vendor.t($data.month),
    p: $data.dateHeight * 6 + "px",
    q: common_vendor.t(!$props.isRange ? $data.activeDate : $data.startDate),
    r: $data.endDate
  }, $data.endDate ? {
    s: common_vendor.t($data.endDate)
  } : {}, {
    t: $options.disabled ? ".5" : "1",
    v: $options.disabled,
    w: common_vendor.o(($event) => $options.confireBtnClick(false)),
    x: $props.visible ? 1 : "",
    y: common_vendor.n($props.visible ? "mask-show" : ""),
    z: common_vendor.o((...args) => $options.hide && $options.hide(...args)),
    A: common_vendor.o(() => {
    })
  });
}
