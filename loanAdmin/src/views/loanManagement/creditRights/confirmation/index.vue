      ...
      <GiTable row-key="id" :data="dataList" :columns="columns" :loading="loading"
        ...
        <template #custom-left>
          <div style="display: flex">
            <div class="name">债权确认状态</div>
            <a-select v-model="queryForm.status" :options="DisEnableStatusList" placeholder="债权确认状态" allow-clear />
          </div>
          ...
          <div style="display: flex">
            <div class="name" style="width: 200px; margin-left: -20px">确认单生成日期</div>
        ...
        <template #action="{ record }">
          <a-space>
            ...
            <a-link @click="submitOrder(record)"> 确认 </a-link>
          </a-space>
        </template>
      </GiTable>
