import { defineComponent, reactive, computed, watch, createVNode, mergeProps } from "vue";
...
var _ColorPicker = defineComponent({
  ...
  setup(props, {
    ...
    const [mergeValue, setMergeValue] = useMergeState(props.defaultValue, reactive({
