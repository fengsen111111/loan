...
import { defineComponent, createVNode, inject, ref, onMounted, reactive, watch, computed, nextTick, Fragment, cloneVNode, toRef, shallowRef, onBeforeUnmount } from "vue";
...
import { b as bus, a as CHANGE_FULL_SCREEN, E as ERROR_CATCHER, U as UPLOAD_IMAGE, O as OPEN_MODALS, R as REPLACE, c as CHANGE_CATALOG_VISIBLE, d as ON_SAVE, e as CTRL_SHIFT_Z, f as CTRL_Z, g as EVENT_LISTENER } from "./chunks/event-name.mjs";
import { a as appendHandler } from "./chunks/dom.mjs";
import { M as MdModal, I as Icon } from "./chunks/index3.mjs";
import { b as base642File } from "./chunks/index4.mjs";
    ...
    return () => {
      ...
      return createVNode(MdModal, {
        ...
        default: () => {
          ...
          }, [((_a2 = ult.value.clipModalTips) == null ? void 0 : _a2.buttonUpload) || ((_b = ult.value.linkModalTips) == null ? void 0 : _b.buttonOK)])]), createVNode("input", {
            "ref": uploadRef,
            "accept": "image/*",
            "type": "file",
            "multiple": false,
